    ...
    <>
      ...
      <section style={{ padding: "180px 24px 140px", textAlign: "center", position: "relative" }}>
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          <FadeIn delay={0.2}><p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 18, color: "rgba(255,255,255,0.55)", maxWidth: 520, margin: "0 auto 56px", lineHeight: 1.75 }}>Book a free consultation. We'll learn about your business and build a custom growth plan — no pressure, no obligations.</p></FadeIn>
